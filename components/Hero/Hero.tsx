    ...
    <>
      <div className=" overflow-hidden">
        <div className="z-[20]   relative text-white text-[12rem] max-lg:text-[4rem] flex flex-col justify-center items-center h-screen ">
          <motion.div
            className="absolute top-40 z-40 bg-[white] h-[2px] w-0  sm:w-0 lg:max-w-[55%] max-lg:top-44"
          ...
          <motion.div
            className="absolute bottom-40 z-40 bg-[white] h-[2px] w-0  sm:w-0 lg:max-w-[55%] max-lg:bottom-44"
            animate={{ width: "80vw" }} // final state
            transition={{ duration: 3, ease: "easeInOut" }} // animation settings
          ></motion.div>
        </div>
